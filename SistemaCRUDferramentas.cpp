...
int main() {
    ...
    printf("\nDigite a producao: ");
    scanf("%lf", &producao);  // Corrigido o formato para %lf para double
    ...
    for (linha = 0; linha < qtdeCaminhao; linha++) {
        ...
        scanf("%lf", &caminhoes[linha][0]);  // Corrigido o formato para %lf para double
        capacidadeTotal += caminhoes[linha][0];

        printf("\nDigite a quilometragem percorrida: ");
        scanf("%lf", &caminhoes[linha][1]);  // Corrigido o formato para %lf para double

        printf("\nDigite o valor por KM rodado: ");
        scanf("%lf", &caminhoes[linha][2]);  // Corrigido o formato para %lf para double
    }
